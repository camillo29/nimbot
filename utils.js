...
export function getRandomAnimal() {
    const animals = ['lisem', 'wilkiem', 'niedźwiedziem', 'jeleniem', 'łosiem', 'dzikiem', 'borsukiem', 'kuną', 'wydrą', 'wiewiórką', 'zającem', 'jeżem', 'rysiem', 'żbikiem', 'gronostajem', 'łasicą', 'bobrem', 'norką', 'szczurem', 'jenotem', 'nietoperzem', 'myszą', 'nornicą', 'ryjówką', 'orłem', 'sową', 'krukiem', 'dzięciołem', 'sójką', 'żmiją', 'zaskrońcem', 'jaszczurką', 'żabą'];
